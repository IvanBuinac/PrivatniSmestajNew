            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        {!! Form::open(['method' => 'GET', 'route' => 'permissions.index', 'class' => 'navbar-form navbar-right', 'role' => 'search'])  !!}
                                ...
                                @foreach($permissions as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('permissions.edit',$item->id) }}" title="Edit permission"><button class="btn btn-primary btn-xs"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
                                            {!! Form::open([
                                                'method'=>'DELETE',
