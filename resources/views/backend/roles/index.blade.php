            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        {!! Form::open(['method' => 'GET', 'route' => 'roles.index', 'class' => 'navbar-form navbar-right', 'role' => 'search'])  !!}
                                ...
                                @foreach($roles as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('roles.edit',$item->id) }}" title="Edit role"><button class="btn btn-primary btn-xs"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
                                            {!! Form::open([
                                                'method'=>'DELETE',
