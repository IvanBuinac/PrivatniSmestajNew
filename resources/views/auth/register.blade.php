            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" aria-label="{{ __('Register') }}">
                        ...
                        <div class="form-group{{ $errors->has('telephone') ? ' has-error' : '' }} row">
                            <label for="telephone" class="col-md-4 col-form-label text-md-right">{{trans("registration.telephone")}}</label>
